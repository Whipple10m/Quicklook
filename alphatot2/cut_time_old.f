...
*     vector ra,dec
      ...
      cuts(4)=(t10totsig.gt.cv(7))
      cuts(5)=(t10sinalpha.lt.cv(11))
      cuts(6)=(t10max1.gt.cv(8)).and.(t10max2.gt.cv(9))
      cuts(7)=(t10sinalpha.gt.cv(12)).and.(t10sinalpha.lt.cv(13))
      cuts(8)=((t10length/t10totsig).gt.cv(14)).and.
     +        ((t10length/t10totsig).lt.cv(15))
      cuts(9)=t10asymm.gt.cv(16)
      cuts(10)=t10nb3.gt.cv(10)
