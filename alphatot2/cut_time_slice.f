      REAL FUNCTION cut_time_slice(mode)
*********************************************************
*                                                       *
...
*
* MAC 971119
* Changed tracking runs to ignore duration matching.  This is mainly
* to allow the runs where the livetime screwed up to be analyzed.
*
      LOGICAL         CHAIN
      CHARACTER*128   CFILE
...
*     +     (t10max2.lt.cv(12)))
      cuts(6)=((t10max1.lt.cv(10)).or.(t10max2.lt.cv(12)))
...
* If it's a tracking run, don't worry about the duration (to save runs where
* livetime fails)
*save      if (mode.gt.2.2) then
*save         cuts(11)=t10livetime.eq.t10livetime
*save      else
      cuts(11)=(t10livetime.gt.cv(20)).and.(t10livetime.lt.cv(21))
*save      endif
