...
C     Write Header/Cuts
      ...
      write(20,130)cv(7),cv(9),cv(11)  !size/max1/max2 lower bound
      write(20,140)cv(8),cv(10),cv(12) !size/max1/max2 upper bound
      write(20,150)cv(13)       !nbr3
      alpha=asin(cv(14))*(45.0/atan(1.0))
...
C
 10   read(1,200,end=50) onfile,(on(i),i=1,7)
      ...
      write(20,220)(max(-99.99,min(99.99,excess(i))),i=1,7)
 ...
 50   continue
      ...
      write(20,220)(max(-99.99,min(99.99,sigmas(i))),i=1,7)
 ...
 130  format(1x,'Size > ',f6.0,', 1/91 > ',f4.0,',  2/91 > ',f4.0)
 140  format(1x,'Size < ',f7.0,' or 1/91 < ',f7.0,
     +     ' or  2/91 < ',f7.0)
 150  format(1x,'Nbr3 > ',f3.1)
 160  format(1x,'Alpha < ',f6.2,' degrees.')
 300  format(79('-'))
 310  format(14x,'Raw',7x,'Nbr3',5x,'Trigger',5x,'Shape',3x,'Sh2090',
     +       3x,'Orient',3x,'Gammas')
